        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-8">
            <div className="p-4 bg-white rounded shadow flex flex-col">
              <span className="text-gray-500">Amount Debited</span>
            ...
            <div className="p-4 bg-white rounded shadow flex flex-col">
              <span className="text-gray-500">Amount Budgeted</span>
            ...
            <div className="p-4 bg-white rounded shadow flex flex-col">
              <span className="text-gray-500">Amount Spent (outflows)</span>
            ...
            <div className="p-4 bg-white rounded shadow flex flex-col">
              <span className="text-gray-500">Amount Saved (so far)</span>
            ...
            <div className="p-4 bg-white rounded shadow flex flex-col">
              <span className="text-gray-500">Balance (From Debited)</span>
            ...
            <div className="p-4 bg-white rounded shadow flex flex-col">
              <span className="text-gray-500">Balance (Usable)</span>
              <span className={`text-xl font-semibold ${balanceColor}`}>
            ...
            <div className="p-4 bg-white rounded shadow flex flex-col">
              <span className="text-gray-500">Amount Lost</span>
          ...
          <div className="mb-8 p-4 bg-white rounded shadow">
            ...
            <div className="flex h-6 w-full bg-gray-200 rounded overflow-hidden">
              <div
            ...
            <div className="flex justify-between text-sm text-gray-600 mt-1">
              <span>Spent: {spentExcludingSavings.toLocaleString()}</span>
              <span>Saved: {savedSoFar.toLocaleString()}</span>
